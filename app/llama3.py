...
5. **Output ONLY the rewritten Target Text.** Do not include the Reference Text, explanations, or any other text.
...
def generate_tone_transformed_text(reference_text, target_text):
    """
    Sends a request to the Ollama API to generate transformed text.
    """
    ...
    try:
        ...
        print(f"Error in generate_tone_transformed_text(): {str(e)}")
